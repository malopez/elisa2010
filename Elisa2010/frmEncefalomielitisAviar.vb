...
Public Class frmEncefalomielitisAviar
   ...
   Private Sub cmbNoCaso1_Click(sender As Object, e As System.EventArgs) Handles cmbNoCaso1.Click
      Try
         ...
         Dim oDataAdapter = New MySqlDataAdapter("SELECT  o.caso,a.id_analysis as IDAN FROM ordenes o,analisis a WHERE o.id_area=3 and o.id_status=1 and o.AnalisisSolicitados=a.id_analysis and  a.analysis_desc like '%INMUNOENSAYO%ENCEFALOMIELITIS%' and id_analysis='" & tabla(0) & "' order by o.caso,a.id_analysis asc", oConexion)
         Dim oDataSet As New DataSet()
         oConexion.Open()
