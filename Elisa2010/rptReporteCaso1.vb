...
Public Class rptReporteCaso1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Elisa2010.rptReporteCaso1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReporteCaso1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReporteCaso1 = New rptReporteCaso1()
        rpt.Site = Me.Site
        Return rpt
    End Function
