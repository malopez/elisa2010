...
Public Class rptReporteCaso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Elisa2010.rptReporteCaso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReporteCaso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReporteCaso = New rptReporteCaso()
        rpt.Site = Me.Site
        Return rpt
    End Function
