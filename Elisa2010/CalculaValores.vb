Module CalculaValores
   Public Sub calculaLarin()
      ...
      'La placa es de A1 a H12, primer columna del arreglo es de A1 a A12, segunda de B1 a B12, octava de H1 a H12
      ...
      'Presenta datos
      fmbSalidaDatos.txtMediaAritmetica.Text = CStr(calculaMedia)
      fmbSalidaDatos.txtMediaAritmetica2.Text = CStr(mediaAritmetica)
      fmbSalidaDatos.txtMediaGeometrica.Text = CStr(mediaGeometrica)
      fmbSalidaDatos.txtCoefVariacion.Text = CStr(coeficienteDeVariacion)
      fmbSalidaDatos.txtDesvEstandar.Text = CStr(desviacionEstandar)
      fmbSalidaDatos.txtVarianza.Text = CStr(calculaVarianza)
      fmbSalidaDatos.txtTotalDatosCalculados.Text = CStr(cuentaNoDatos)
   End Sub
